...
export const CHARACTERS: { [key: string]: Character } = {
  ...
  'Mileena': {
    ...
    slug: 'mileena',
    type: 'Rushdown',
    description: 'Sister of Kitana and empress of Outworld',
    color: 'rgb(224, 32, 96)',
  ...
  'Noob Saibot': {
    ...
    colorDark: 'rgb(0, 0, 0)',
    health: 700,
    pros: ['Good setplay', 'Strong Mixups and pressure'],
    cons: ['Complex execution'],
    stats: {
      offense: 4,
      defense: 3,
  ...
  'Peacemaker': {
    ...
    colorDark: 'rgb(112, 0, 0)',
    health: 650,
    pros: ['Strong fatal blow', 'Good projectiles'],
    cons: ['Eagley cooldown'],
    stats: {
      offense: 4,
      defense: 5,
      damage: 3,
  ...
  'Raiden': {
    ...
    slug: 'raiden',
    type: 'Balanced',
    description: 'Earthrealm champion and resident farmer',
    color: 'rgb(128, 192, 255)',
    colorDark: 'rgb(64, 96, 128)',
    health: 700,
    pros: ['Built in mixups', 'Strong normals'],
    cons: ['Mid projectiles'],
    stats: {
      offense: 4,
      defense: 3,
      damage: 3,
  ...
  'Rain': {
    ...
    health: 700,
    pros: ['Good Setplay', 'Strong Midrange'],
    cons: ['Complex execution'],
    stats: {
      offense: 4,
      defense: 3,
  ...
  'Sindel': {
    ...
    health: 700,
    pros: ['Strong buttons', 'Strong zoning'],
    cons: ['N/A'],
    stats: {
      offense: 5,
      defense: 4,
  ...
  'Sub-Zero': {
    ...
    colorDark: 'rgb(0, 32, 64)',
    health: 700,
    pros: ['Strong defense', 'Good Buttons'],
    cons: ['Low damage','No mix'],
    stats: {
      offense: 3,
      defense: 5,
      damage: 3,
  ...
  'Conan': {
    ...
    cons: ['Slower attacks and movement'],
    stats: {
      offense: 4,
      defense: 3,
      damage: 4,
